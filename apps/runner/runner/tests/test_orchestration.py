...
def test_heartbeat_is_sent_while_execution_active(monkeypatch):
    ...
    def patched_init(self, client, execution_id, claim_token, interval=10, cancellation_event=None):
        original_init(self, client, execution_id, claim_token, interval=0.01, cancellation_event=cancellation_event)  # fast
