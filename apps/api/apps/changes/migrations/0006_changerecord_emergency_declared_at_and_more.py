...
class Migration(migrations.Migration):
    dependencies = [
        (
            "approvals",
            "0006_remove_approvalrequest_approval_req_subject_type_valid_chk_and_more",
        ),
    ...
    operations = [
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("window_overrun", "Window Overrun"),
                            ("late_verification", "Late Verification"),
        ...
        migrations.AddIndex(
            model_name="breakglasssession",
            index=models.Index(
                fields=["change_record", "status"], name="bglsess_change_status_idx"
            ),
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    (
                        "review_status__in",
                        ["pending", "submitted", "accepted", "overdue", "blocked"],
                    )
                ),
        ...
        migrations.AddIndex(
            model_name="changeexception",
            index=models.Index(
                fields=["approval_request"], name="chgexc_approval_req_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="changeexception",
        ...
        migrations.AddIndex(
            model_name="retroreview",
            index=models.Index(
                fields=["change_record", "status"], name="retrorev_change_status_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="retroreview",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ...
                    (
                        "disposition__in",
                        ["accepted", "needs_remediation", "control_failure"],
                    ),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ...
                    models.Q(("disposition", ""), _negated=True),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("breakglass_session_id__isnull", False),
                    ("change_exception_id__isnull", False),
                    _connector="OR",
                ),
